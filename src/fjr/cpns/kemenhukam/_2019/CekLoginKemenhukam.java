...
public class CekLoginKemenhukam {
	
	BufferedReader reader = null; 
	
	PrintWriter out  = null, out1 = null ; 
	
	public CekLoginKemenhukam() {
		String content = null; 
		HtmlPage page1 = null;
		...
		try {
			out = new PrintWriter(new FileOutputStream("E:/birokrasi/lamaran kerja/CPNS 2019/kementerian hukum dan ham/sulawesi-sukses.txt" )); 
			out1 = new PrintWriter(new FileOutputStream ( "E:/birokrasi/lamaran kerja/CPNS 2019/kementerian hukum dan ham/sulawesi-log.txt")); 
					
			reader = new BufferedReader(new FileReader( "E:/birokrasi/lamaran kerja/CPNS 2019/kementerian hukum dan ham/Daftar-Sulawesi.txt"  ));
