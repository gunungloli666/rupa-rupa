...
public class Kemenkumham {
	...
	public  Kemenkumham () throws IOException {
		out = new PrintWriter(new FileOutputStream( "E:/birokrasi/lamaran kerja/CPNS 2019/kementerian hukum dan ham/daftar-sulawesi.txt"   ));
		File f = new File( "E:/birokrasi/lamaran kerja/CPNS 2019/kementerian hukum dan ham/Sarjana.txt" ); 
		...
		while(m.find()) {
			...
			if(sb.startsWith("7")) { // untuk sulawesi saja
				out.println(sb);
				out.flush();
			}
		}
